...
@njit
def build_chunk_mesh(chunk_voxels, format_size, chunk_pos, world_voxel):
    ...
    for x in range(CHUNK_SIZE):
        for y in range(CHUNK_SIZE):
            for z in range(CHUNK_SIZE):
                ...
                # top face
                if is_void((x, y + 1, z), (wx, wy + 1, wz), world_voxel):
                    # @formatter:off
                ...
                # right face
                if is_void((x + 1, y, z), (wx + 1, wy, wz), world_voxel):
                    # @formatter:off
                ...
                # back face
                if is_void((x, y, z - 1), (wx, wy, wz - 1), world_voxel):
                    # @formatter:off
                ...
                if is_void((x, y, z + 1), (wx, wy, wz + 1), world_voxel):
                    ...
                    v3 = to_uint8(x + 1, y,     z + 1, voxel_id, 5)  # 5 is face_id
                    # @formatter:on
                    index = add_data(vertex_data, index, v0, v2, v1, v0, v3, v2)
